...
import { createHero, damageHero, moveHero } from './hero.ts'
...
import { HERO_BASE_SPEED, LEVEL_BASE_PROGRESSION, LEVEL_BASE_XP, WORLD_BOUNDS } from './constants.ts'
import { WeaponHud } from './view/hud/WeaponHud.ts'
import { GameOverHud } from './view/hud/GameOverHud.ts'
